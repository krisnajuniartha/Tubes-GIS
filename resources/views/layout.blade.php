...
<head>
    ...
    <title>Ruas Jalan Bali</title>
    <!-- <link rel="icon" type="image/x-icon" href="{{ asset('landingpage/assets/favicon.ico') }}" /> -->
    <link href="{{ asset('assets/img/icon_web.png') }}" rel="icon">
    ...
    {{-- <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy;I Gede Krisna Juniartha</div>
                <div class="col-lg-4 my-3 my-lg-0">
                    <a class="btn btn-dark btn-social mx-2"
                        href="https://www.facebook.com/profile.php?id=100018244002863" aria-label="Instagram"><i
                            class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-dark btn-social mx-2" href="https://www.linkedin.com/in/kisnajuniartha/"
