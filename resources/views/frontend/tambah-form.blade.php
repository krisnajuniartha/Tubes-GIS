    ...
    <section class="page-section" id="map-form-section">
        ...
        <script>
            document.getElementById('ruasForm').addEventListener('submit', function(event) {
                ...
                // Mengambil nilai dari setiap elemen form
                var paths = document.getElementById('paths').value;
                var kodeRuas = document.getElementById('kode_ruas').value;
                var namaRuas = document.getElementById('nama_ruas').value;
                ...
                var perkerasan = document.getElementById('perkerasan-dropdown').value;
                var jenisJalan = document.getElementById('jenisjalan-dropdown').value;
                var kondisiJalan = document.getElementById('kondisiJalan-dropdown').value;

                // Menampilkan nilai-nilai dalam console log
                console.log("Paths:", paths);
                console.log("Kode Ruas:", kodeRuas);
                console.log("Nama Ruas:", namaRuas);
                ...
                console.log("Perkerasan Eksisting:", perkerasan);
                console.log("Jenis Jalan:", jenisJalan);
                console.log("Kondisi Jalan:", kondisiJalan);
